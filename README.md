...
| **Qwen3.5-2B** | —<br><sub>Mac ship: naive ceiling ~26 tok/s ≈ CoreML-2B parity at a tighter RAM budget</sub> | — | **127 tok/s**<br><sub>int8 linear · loop-free × pipelined engine</sub> |
